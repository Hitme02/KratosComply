...
COMPLIANCE_CONTROLS: dict[str, ComplianceControl] = {
    ...
    "weak_encryption": ComplianceControl(
        control_id="GDPR-Article-32",
        control_category=ControlCategory.ENCRYPTION,
        evidence_type=EvidenceType.CODE_PROOF,
        frameworks=["GDPR", "ISO27001", "HIPAA", "PCI-DSS", "NIST-CSF"],
        description="Weak encryption algorithms must not be used",
        auditor_explanation="Weak ciphers (TripleDES, Blowfish, ARC4) and SSL/TLS misconfigurations violate encryption requirements.",
    ),
    "weak_authentication": ComplianceControl(
        control_id="SOC2-CC6.1",
        control_category=ControlCategory.ACCESS_CONTROL,
        evidence_type=EvidenceType.CODE_PROOF,
        frameworks=["SOC2", "ISO27001", "GDPR", "DPDP", "HIPAA", "PCI-DSS", "NIST-CSF"],
        description="Authentication mechanisms must use secure password hashing",
        auditor_explanation="Plaintext password comparison and storage violate access control and data protection requirements.",
    ),
    "missing_logging": ComplianceControl(
        control_id="SOC2-CC7.2",
        control_category=ControlCategory.LOGGING,
        evidence_type=EvidenceType.CODE_PROOF,
        frameworks=["SOC2", "ISO27001", "GDPR", "DPDP", "HIPAA", "PCI-DSS", "NIST-CSF"],
        description="Security events must be logged",
        auditor_explanation="Missing authentication and security event logging creates audit trail gaps.",
    ),
